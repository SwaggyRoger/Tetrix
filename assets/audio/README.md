...
| combo 越高越激昂 | 連續消行時四個軸一起疊：**真正移調**（每階 3 個半音）、音量變大、殘響拉長，第 3 次連消起加上一層高音閃爍。第 5 連時整體比第 1 連高一個八度、能量 2.3 倍 |
...
**第 3 連以上的高音閃爍層在你覆蓋該 cue 時不會加上去** —— 覆蓋就是覆蓋，你給的
音檔會原封不動播出，不會被我們的合成音疊加。想保留 combo 的堆疊感，就別覆蓋
`clear1`~`clear4`。
